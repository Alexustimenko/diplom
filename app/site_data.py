...
STATIC_PAGES = {
    ...
    "kreslo-v-rassrochky": ("Рассрочка", "Кресло в рассрочку", "Возможность рассрочки и её срок зависят от действующих предложений партнёров. Уточните доступные варианты перед заказом."),
